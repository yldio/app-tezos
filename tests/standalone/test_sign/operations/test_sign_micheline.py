...
from utils.message import Default, Micheline, MichelineExpr
...
prim_cases: list[tuple[Micheline, str]] = [
    ...
    (
        {"prim": "view", "args": [{"string": ""}, *default_view_interface]},
        "small-view-name",
    ),
    (
        {"prim": "view", "args": [{"string": "v" * 31}, *default_view_interface]},
        "long-view-name",
    ),
    (
        {"prim": "view", "args": [{"string": "view\nname"}, *default_view_interface]},
        "view-name-with-newline",
    ),
    # Data
    ({"prim": "False"}, "False"),
    ...
    (
        {
            "prim": "Ticket",
            "args": [
                {"string": Default.ORIGINATED_ADDRESS + "%my_entrypoint"},
                {"prim": "unit"},
                {"prim": "Unit"},
                {"int": 0},
            ],
    ...
    (
        {
            "prim": "Lambda_rec",
            "args": [[{"prim": "DROP"}, {"prim": "DROP"}, {"prim": "UNIT"}]],
        },
        "Lambda_rec-data",
    ),
    # Instruction
    ...
    (
        {
            ...
            "args": [
                [
                    ...
                    {
                        "prim": "view",
                        "args": [{"string": "view-name1"}, *default_view_interface],
                    },
                    {
                        "prim": "view",
                        "args": [{"string": "view-name2"}, *default_view_interface],
                    },
                ]
            ],
        },
    ...
    ({"prim": "EDIV"}, "EDIV"),
    (
        {"prim": "EMPTY_BIG_MAP", "args": [{"prim": "unit"}, {"prim": "unit"}]},
        "EMPTY_BIG_MAP",
    ),
    ...
    (
        {
            "prim": "LAMBDA",
            "args": [{"prim": "unit"}, {"prim": "unit"}, [{"prim": "UNIT"}]],
        },
        "LAMBDA-instr",
    ),
    (
    ...
    (
        {"prim": "sapling_transaction", "args": [{"int": 0xFFFF}]},
        "sapling_transaction-max-memo-size",
    ),
    (
        {"prim": "sapling_transaction_deprecated", "args": [{"int": 0xFFFF}]},
    ...
    (
        {"prim": "LEFT", "annots": ["%annot"], "args": [{"prim": "unit"}]},
        "with-annot-and-arg",
    ),
    (
        {
            "prim": "unit",
            "annots": [":" + ascii_lowercase + ascii_uppercase + "_" + digits],
        },
        "allowed-char-annot",
    ),
    (
        {
            "prim": "unit",
            "annots": [":" + (ascii_lowercase * ((254 // len(ascii_lowercase)) + 1))[:254]],
        },
        "max-len-annot",
    ),
]
...
real_cases: list[tuple[Micheline, str]] = [
                ...
                [
                    {
                        ...
                        "args": [
                            {
                                "string": "edsigtXomBKi5CTRf5cjATJWSyaRvhfYNHqSUGrn4SdbYRcGwQrUGjzEfQDTuqHhuA8b2d8NarZjz8TRf65WkpQmo423BtomS8Q"  # noqa: E501
                            }
                        ],
                    },
                    {"prim": "None"},
    ...
    (
        [
            ...
            {"prim": "UNPAIR", "annots": ["@stored_counter"]},
            {"prim": "DIP", "args": [[{"prim": "SWAP"}]]},
            {"prim": "COMPARE"},
            {"prim": "EQ"},
            {"prim": "IF", "args": [[], [{"prim": "UNIT"}, {"prim": "FAILWITH"}]]},
            {"prim": "DIP", "args": [[{"prim": "SWAP"}]]},
            {"prim": "UNPAIR", "annots": ["@threshold", "@keys"]},
            {
                "prim": "DIP",
                "args": [
                    [
...
def _all_params(
    cases: list[tuple[list[tuple[Micheline, str]], str]],
) -> list[ParameterSet]:
    return [p for cases_ in cases for p in _params(*cases_)]
