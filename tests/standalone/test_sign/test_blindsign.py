...
BASIC_OPERATION = OperationGroup(
    [
        ...
        SetDepositLimit(
            source="tz1ixvCiPJYyMjsp2nKBVaq54f6AdbV8hCKa", fee=1000000, counter=15, gas_limit=1, storage_limit=3, limit=10000000
        ),
    ]
)
...
def test_sign_basic_too_long_operation(
    backend: TezosBackend, device: Device, tezos_navigator: TezosNavigator, account: Account, snapshot_dir: Path
):
...
def test_reject_at_skip(backend: TezosBackend, tezos_navigator: TezosNavigator, account: Account, snapshot_dir: Path):
...
def test_reject_too_long_operation_with_too_large_at_blindsigning_warning(
    backend: TezosBackend, tezos_navigator: TezosNavigator, account: Account, snapshot_dir: Path
):
    """Check reject too long operation that will also fail the parsing at blindsigning"""
...
def test_blindsign_too_deep(
    ...
    expression = MichelineExpr(
        [[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[{"int": 42}]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]
    )

    with backend.sign(account, expression, with_hash=True) as result:
        if device.type == DeviceType.NANOS:
            ### Simulate `navigate_review` up to `ACCEPT_RISK` because the nanos screen can look like it hasn't changed.  # noqa: E501
    ...
    account.check_signature(message=expression, with_hash=True, data=result.value)
...
def test_ensure_always_clearsign(
    ...
    message = Transaction(
        ...
        amount=0,
        entrypoint="root",
        parameter = [{"prim":"pair","args":[{"string":"["},{"prim":"pair","args":[{"string":"Z"},{"prim":"pair","args":[{"string":"Y"},{"prim":"pair","args":[{"string":"X"},{"prim":"pair","args":[{"string":"W"},{"prim":"pair","args":[{"string":"V"},{"prim":"pair","args":[{"string":"U"},{"prim":"pair","args":[{"string":"T"},{"prim":"pair","args":[{"string":"S"},{"prim":"pair","args":[{"string":"R"},{"prim":"pair","args":[{"string":"Q"},{"prim":"pair","args":[{"string":"P"},{"prim":"pair","args":[{"string":"O"},{"prim":"pair","args":[{"string":"N"},{"prim":"pair","args":[{"string":"M"},{"prim":"pair","args":[{"string":"L"},{"prim":"pair","args":[{"string":"K"},{"prim":"pair","args":[{"string":"J"},{"prim":"pair","args":[{"string":"I"},{"prim":"pair","args":[{"string":"H"},{"prim":"pair","args":[{"string":"G"},{"prim":"pair","args":[{"string":"F"},{"prim":"pair","args":[{"string":"E"},{"prim":"pair","args":[{"string":"D"},{"prim":"pair","args":[{"string":"C"},{"prim":"pair","args":[{"string":"B"},[]]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]}]},{"prim":"pair","args":[{"int":10},{"prim":"pair","args":[{"int":9},{"prim":"pair","args":[{"int":8},{"prim":"pair","args":[{"int":7},{"prim":"pair","args":[{"int":6},{"prim":"pair","args":[{"int":5},{"prim":"pair","args":[{"int":4},{"prim":"pair","args":[{"int":3},{"prim":"pair","args":[{"int":2},{"prim":"pair","args":[{"int":1},[]]}]}]}]}]}]}]}]}]}]}]  # noqa: E501
    )
    # fmt: on
